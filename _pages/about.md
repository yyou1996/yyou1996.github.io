...
E.g. (i) contrastive learning on graphs ([GraphCL](https://arxiv.org/abs/2010.13902)) with (ii) its automated version ([JOAO](https://arxiv.org/abs/2106.07594)), and (iii) applications in drug discovery ([CPAC](https://www.biorxiv.org/content/10.1101/2020.11.29.403162v1)) and stock prediction ([AR-Stock](https://aaai-kdf.github.io/kdf2021/assets/pdfs/KDF_21_paper_5.pdf)).
