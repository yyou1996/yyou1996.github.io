...
News
=====
🐯**2022/10.** "[Does Inter-Protein Contact Prediction Benefit from Multi-Modal Data and Auxiliary Tasks?]()" (multi-modal multi-task protein interface prediction) accepted @ MLSB Workshop, NeurIPS'22. \\
