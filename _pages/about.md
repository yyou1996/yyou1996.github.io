...
E.g. (i) contrastive learning on graphs ([GraphCL](https://arxiv.org/abs/2010.13902)) with (ii) its automated version ([JOAO](https://arxiv.org/abs/2106.07594)), and (iii) an application on [CPAC](https://www.biorxiv.org/content/10.1101/2020.11.29.403162v1).
...
**May.** Publish "[Graph Contrastive Learning Automated](https://arxiv.org/abs/2106.07594)" ([long presentation](https://github.com/Shen-Lab/GraphCL_Automated/blob/master), automatic augmentation selection in GraphCL) @ ICML’21. \\
