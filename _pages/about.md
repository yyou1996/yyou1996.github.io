...
📖**Research.** My research interests focus on **modeling of non-Euclidean data with limited labels and/or distribution shifts, with theoretical analyses and real-world applications to biomolecules**.
...
A GitHub repo maintained by me and some friends about graph self-supervised learning literatures can be found [here](https://github.com/ChandlerBang/awesome-self-supervised-gnn) (+900⭐). \\
<br />
