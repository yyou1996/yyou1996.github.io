...
🕮**Research.** My research interests focus on **representation learning on non-Euclidean data (e.g. graphs) with limited labels and distribution shifts, with fundamental theoretical understanding and challenging real-world applications to biomolecules**.
...
News
=====
🐰**2023/01.** "[Graph Domain Adaptation via Theory-Grounded Spectral Regularization](https://openreview.net/forum?id=OysfLgrk8mk)" (model-based risk bound analysis of GDA) accepted @ ICLR'23. 😊
