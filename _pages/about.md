...
🕮**Research.** I am interested in **machine learning** on **non-Euclidean** data (e.g. graphs) with limited labels and distribution shifts, with fundamental understanding in theory and challenging real-world applications to **biomedicine**.
