...
I lead the **AI for Life Sciences Laboratory**, where we build AI foundation models on structured biological data to simulate living systems across species and biological scales.
...
<div markdown="1">
  ...
  (TotalCitations:<!-- graphcl-citations-start -->4849<!-- graphcl-citations-end -->)
